            ...
            <div class="applications">
                <div class="applications__top flex">
                    ...
                    <div class="applications__top-right flex">
                        ...
                        <a href="<?= site_url('profile/cities/add'); ?>" class="applications__top-btn btn-item">
                            ...
                            <table>
                                <thead>
                                    <tr>
                                        ...
                                        <th class="<?= ($_GET['sort'] == 'title' && $_GET['sort_type'] == 'asc' ? 'active' : ''); ?>"><a href="?sort=title&sort_type=<?= ($_GET['sort'] == 'title' && $_GET['sort_type'] == 'asc' ? 'desc' : 'asc'); ?>">Название города</a> <img src="<?= base_url();?>/assets/img/icons/arrow-table.svg" alt=""></th>
                                        <th class="<?= ($_GET['sort'] == 'status' && $_GET['sort_type'] == 'asc' ? 'active' : ''); ?>"><a href="?sort=status&sort_type=<?= ($_GET['sort'] == 'status' && $_GET['sort_type'] == 'asc' ? 'desc' : 'asc'); ?>">Статус</a> <img src="<?= base_url();?>/assets/img/icons/arrow-table.svg" alt=""></th>
                                        <th></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php foreach ($items as $city) { ?>
                                        <tr data-id="<?= $city['id']; ?>">
                                            ...
                                            <td><?= $city['title']; ?></td>
                                            <td>
                                                <div class="stats stats_<?= ($city['status'] == 1 ? 'green' : 'red'); ?>">
                                                    <span></span> <?= ($city['status'] == 1 ? 'Активный' : 'Не активный'); ?>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="table-actions">
                                                    <a href="<?= site_url('profile/cities/edit/' . $city['id'] . ''); ?>" class="edit table-actions__edit">
                                                        <i class="ic ic-edit"></i>																										
                                                    </a>
                                                    <a href="#" class="delete table-actions__delete" data-title="<?= $city['title']; ?>" data-id="<?= $city['id']; ?>">
                ...
                <?php if($items){ ?>
                    <div class="applications__bottom flex-center">
                        ...
                        <?= ($pager ? $pager->links('cities', 'peoples_pagination') : ''); ?>
...
<div id="delete-modal" class="callback-modal modal" style="display: none;">
    ...
    <div class="modal__body">
        ...
        <div class="modal__subtitle">Вы действительно хотите удалить город <span class="modal__name"></span></div>
        <div class="modal__buttons flex">
            ...
            <input type="hidden" name="base_url" value="<?= site_url('Admin/City/delete_ajax'); ?>">
        </div>
    </div>
...
<div id="delete-success-modal" class="callback-modal modal" style="display: none;">
    ...
    <div class="modal__body">
        ...
        <div class="modal__subtitle">Город <span class="modal__name"></span> успешно удален!</div>
        <div class="modal__buttons flex">
