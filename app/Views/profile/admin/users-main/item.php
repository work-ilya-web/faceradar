                    ...
                    <form method="post" class="applications__form">
                        ...
                        <div class="applications__form-two">
                            ...
                            <div class="applications__form-item">
                                ...
                                <div class="select select_item">
                                    <div class="select-title">
                                        <div class="select-title__value"><?= ($groups_current ? $groups_current['name'] : 'Клиент'); ?></div>
                                        <div class="select-title__arrow"></div>
                                    </div>
                                    <div class="select-options">
                                        <?php foreach ($groups as $group) { ?>
                                            <div class="select-options__value" data-value="<?= $group['id']; ?>">
                                                <span><?= $group['name']; ?></span>
                                            </div>
                                        <?php } ?>
                                        <input type="hidden" name="group" value="<?= ($groups_current ? $groups_current['permission'] : '2'); ?>">
                                    </div>
                                </div>
                            </div>
                            <?php } ?>
