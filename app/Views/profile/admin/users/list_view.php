...
<div class="clients">
	...
	<div class="clients__top flex">
		<div class="clients__top-left">
            ...
            <a href="<?= site_url('profile/users/add'); ?>" class=" clients__top-btn btn-item ">
                        ...
                        <tr data-id="<?= $user['user_id']; ?>">
                            ...
                            <td>
                                <div class="table-actions">
                                    <a href="<?= site_url('profile/users/edit/' . $user['user_id'] . ''); ?>" class="edit table-actions__edit table-icon">
