            ...
            <div class="applications">
                <div class="applications__top flex">
                    ...
                    <div class="applications__top-right flex">
                            ...
                            <div class="applications__top-select">
                                <div class="select select_item">
                                    ...
                                    <div class="select-options">
                                        ...
                                        <div class="select-options__value" data-value="phone">
                                            <span>Телефон</span>
                                        </div>
                        ...
                        <a href="<?= site_url('profile/users/add'); ?>" class="applications__top-btn btn-item">
                                        ...
                                        <tr data-id="<?= $user['user_id']; ?>">
                                            ...
                                            <td>
                                                <div class="table-actions">
                                                    <a href="<?= site_url('profile/users/edit/' . $user['user_id'] . ''); ?>" class="edit table-actions__edit">
                ...
                <?php if($items){ ?>
                    <div class="applications__bottom flex-center">
                        <?= ($pager ? $pager->links('users', 'peoples_pagination') : ''); ?>
...
<div id="delete-modal" class="callback-modal modal" style="display: none;">
    ...
    <div class="modal__body">
        ...
        <div class="modal__buttons flex">
            ...
            <input type="hidden" name="base_url" value="<?= site_url('Admin/Users/delete_ajax'); ?>">
        </div>
    </div>
