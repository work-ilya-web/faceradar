                        ...
                        <tr data-id="<?= $user['user_id']; ?>">
                            ...
                            <td>
                                <div class="table-actions">
                                    <a href="<?= site_url('receptions/edit/' . $user['user_id'] . ''); ?>" class="edit table-actions__edit table-icon">
                            ...
                            <td>
                                <div class="table-actions">
                                    <a href="<?= site_url('receptions/delete_ajax/' . $user['user_id'] . ''); ?>"  data-id="<?= $user['user_id']; ?>" class="delete delete--js table-actions__delete table-icon">
